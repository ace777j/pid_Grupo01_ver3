...
namespace ProyectoPidG01.Models
{
    ...
    public partial class DB_PIGrupo01Entities1 : DbContext
    {
        public DB_PIGrupo01Entities1()
            : base("name=DB_PIGrupo01Entities1")
        {
        }
        ...
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_DepartamentoListar_Result>("usp_DepartamentoListar");
        }
